...
sel_rev = st.sidebar.multiselect("Revenue Category Filter", options=rev_options)
...
if len(date_cols) > 1:
    ...
    st.plotly_chart(create_advanced_chart(trend_days, day_values, "Average Availability for Last 6 Days", "#3b82f6", "Availability"), use_container_width=True)
